...
Now we can specify state transitions:
| S1 | S2 | Ta | Tb | S'1 | S'2 |
|----|----|----|----|-----|-----|
|  0 |  0 |  0 |  X |  0  |  1  |
|  0 |  0 |  1 |  X |  0  |  0  |
...
With all this in mind we can create a schematics for this Moore machine, following 
Moore machine representations.

![Light trafic schematics](./ch03/light_trafic_schematics.svg)
