...
pMOS transistor pass 1 well but 0 poorly. nMOS transistor pass 0 well but 1 
poorly. Luckily, it's possible to create logic gate that only use transistor 
...
TODO: draw schematics on paper of some logic gate using pmos and nmos
transistors, take a picture and upload it here.
